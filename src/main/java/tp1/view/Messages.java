...
public class Messages {
	...
	public static final String COMMAND_EXECUTE = "Command execute problem";
...
//Commands
	public static final String UNKNOWN_COMMAND = "Error: Unknown command: %s";
...
//Symbols
	...
	public static final String BOX_EMPTY = "0000";

//Action`s messages
	public static final String COMMAND_ACTION_NAME = "accion";
	public static final String COMMAND_ACTION_SHORTCUT = "a";
	public static final String COMMAND_ACTION_DETAILS = "U/UP-D/DOWN-R/RIGHT-L/LEFT";
	public static final String COMMAND_ACTION_HELP = "Press to move";

//Reset messages
	public static final String COMMAND_RESET_NAME = "reset";
	public static final String COMMAND_RESET_SHORTCUT = "r";
	public static final String COMMAND_RESET_DETAILS = "0/1";
	public static final String COMMAND_RESET_HELP = "Press to reset gameView";

//Update messages
	public static final String COMMAND_UPDATE_NAME = "update";
	public static final String COMMAND_UPDATE_SHORTCUT = "u";
	public static final String COMMAND_UPDATE_DETAILS = "U";
	public static final String COMMAND_UPDATE_HELP = "Press to update";

//Exit messages
	public static final String COMMAND_EXIT_NAME = "exit";
	public static final String COMMAND_EXIT_SHORTCUT = "e";
	public static final String COMMAND_EXIT_DETAILS = "E";
	public static final String COMMAND_EXIT_HELP = "Press to exit the game";

//Help messages
	public static final String COMMAND_HELP_NAME = "help";
	public static final String COMMAND_HELP_SHORTCUT = "h";
	public static final String COMMAND_HELP_DETAILS = "H";
	public static final String COMMAND_HELP_HELP = "Press to see how to play";
//AddObject messages
	public static final String COMMAND_OBJECT_NAME = "addObject";
